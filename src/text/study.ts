...
20. **101 Tests full syllabus**: https://1024terabox.com/s/1JIw7MuQDC-3UtVg_Wt91KQ
21. **Akash Test 2024 (FT,FTS,AIATS,NBTS,CT,Intensive)**: https://1024terabox.com/s/14Imzih0HP4ibjcNxnb6x4w
`;

const triggerKeywords = ['Akash', 'Allen', 'Test', 'pw', 'Physics Wallah', 'pdf', 'study material'];

// The `study` object contains the logic to respond with study materials
const study = {
